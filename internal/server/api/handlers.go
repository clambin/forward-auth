...
func Handler(cookieName string, authenticator Authenticator) http.Handler {
	mux := http.NewServeMux()

	mux.Handle("/sessions", sessionsHandler(authenticator))
...
func sessionsHandler(authenticator Authenticator) http.Handler {
